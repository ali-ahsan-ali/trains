...
public enum TripField: String, Hashable, KeyPathVending, Codable{
  /// Route ID field.
...
public struct Trip: Hashable, Identifiable, Codable{
  public let id = UUID()
  ...
  public init(
    ...
    public init(from decoder: Decoder) throws {
        let container: KeyedDecodingContainer<Trip.CodingKeys> = try decoder.container(keyedBy: Trip.CodingKeys.self)
        
        self.routeID = try container.decode(TransitID.self, forKey: Trip.CodingKeys.routeID)
        self.serviceID = try container.decode(TransitID.self, forKey: Trip.CodingKeys.serviceID)
        self.tripID = try container.decode(TransitID.self, forKey: Trip.CodingKeys.tripID)
        self.headSign = try container.decodeIfPresent(String.self, forKey: Trip.CodingKeys.headSign)
        self.shortName = try container.decodeIfPresent(String.self, forKey: Trip.CodingKeys.shortName)
        self.direction = try container.decodeIfPresent(String.self, forKey: Trip.CodingKeys.direction)
        self.blockID = try container.decodeIfPresent(TransitID.self, forKey: Trip.CodingKeys.blockID)
        self.shapeID = try container.decodeIfPresent(TransitID.self, forKey: Trip.CodingKeys.shapeID)
        self.isAccessible = try container.decodeIfPresent(String.self, forKey: Trip.CodingKeys.isAccessible)
        self.bikesAllowed = try container.decodeIfPresent(String.self, forKey: Trip.CodingKeys.bikesAllowed)
        self.nonstandard = try container.decodeIfPresent(String.self, forKey: Trip.CodingKeys.nonstandard)
        
    }
    
    public func encode(to encoder: Encoder) throws {
        var container: KeyedEncodingContainer<Trip.CodingKeys> = encoder.container(keyedBy: Trip.CodingKeys.self)
        
        try container.encode(self.id, forKey: Trip.CodingKeys.id)
        try container.encode(self.routeID, forKey: Trip.CodingKeys.routeID)
        try container.encode(self.serviceID, forKey: Trip.CodingKeys.serviceID)
        try container.encode(self.tripID, forKey: Trip.CodingKeys.tripID)
        try container.encodeIfPresent(self.headSign, forKey: Trip.CodingKeys.headSign)
        try container.encodeIfPresent(self.shortName, forKey: Trip.CodingKeys.shortName)
        try container.encodeIfPresent(self.direction, forKey: Trip.CodingKeys.direction)
        try container.encodeIfPresent(self.blockID, forKey: Trip.CodingKeys.blockID)
        try container.encodeIfPresent(self.shapeID, forKey: Trip.CodingKeys.shapeID)
        try container.encodeIfPresent(self.isAccessible, forKey: Trip.CodingKeys.isAccessible)
        try container.encodeIfPresent(self.bikesAllowed, forKey: Trip.CodingKeys.bikesAllowed)
        try container.encodeIfPresent(self.nonstandard, forKey: Trip.CodingKeys.nonstandard)
    }
}
