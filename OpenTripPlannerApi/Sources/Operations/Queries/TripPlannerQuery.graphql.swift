...
public class TripPlannerQuery: GraphQLQuery {
  ...
  public struct Data: OpenTripPlannerApi.SelectionSet {
    ...
    ///
    /// Parent Type: `Plan`
    public struct Plan: OpenTripPlannerApi.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: ApolloAPI.ParentType { OpenTripPlannerApi.Objects.Plan }
      public static var __selections: [ApolloAPI.Selection] { [
      ...
      ///
      /// Parent Type: `Place`
      public struct From: OpenTripPlannerApi.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: ApolloAPI.ParentType { OpenTripPlannerApi.Objects.Place }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
      ...
      ///
      /// Parent Type: `Place`
      public struct To: OpenTripPlannerApi.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
      ...
      public struct Itinerary: OpenTripPlannerApi.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: ApolloAPI.ParentType { OpenTripPlannerApi.Objects.Itinerary }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
          .field("startTime", OpenTripPlannerApi.Long?.self),
          .field("endTime", OpenTripPlannerApi.Long?.self),
          .field("duration", OpenTripPlannerApi.Long?.self),
          .field("legs", [Leg?].self),
        ] }

        /// Time when the user leaves from the origin. Format: Unix timestamp in milliseconds.
        public var startTime: OpenTripPlannerApi.Long? { __data["startTime"] }
        /// Time when the user arrives to the destination.. Format: Unix timestamp in milliseconds.
        public var endTime: OpenTripPlannerApi.Long? { __data["endTime"] }
        /// Duration of the trip on this itinerary, in seconds.
        public var duration: OpenTripPlannerApi.Long? { __data["duration"] }
        ...
        ///
        /// Parent Type: `Leg`
        public struct Leg: OpenTripPlannerApi.SelectionSet {
          public let __data: DataDict
          public init(_dataDict: DataDict) { __data = _dataDict }

          public static var __parentType: ApolloAPI.ParentType { OpenTripPlannerApi.Objects.Leg }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
            ...
            .field("from", From.self),
            .field("to", To.self),
            .field("mode", GraphQLEnum<OpenTripPlannerApi.Mode>?.self),
          ...
          public var mode: GraphQLEnum<OpenTripPlannerApi.Mode>? { __data["mode"] }
          ...
          ///
          /// Parent Type: `Trip`
          public struct Trip: OpenTripPlannerApi.SelectionSet {
            public let __data: DataDict
            public init(_dataDict: DataDict) { __data = _dataDict }

            public static var __parentType: ApolloAPI.ParentType { OpenTripPlannerApi.Objects.Trip }
            public static var __selections: [ApolloAPI.Selection] { [
              .field("__typename", String.self),
            ...
            public struct Stoptime: OpenTripPlannerApi.SelectionSet {
              public let __data: DataDict
              public init(_dataDict: DataDict) { __data = _dataDict }

              public static var __parentType: ApolloAPI.ParentType { OpenTripPlannerApi.Objects.Stoptime }
              public static var __selections: [ApolloAPI.Selection] { [
                .field("__typename", String.self),
          ...
          ///
          /// Parent Type: `Stop`
          public struct IntermediateStop: OpenTripPlannerApi.SelectionSet {
            public let __data: DataDict
            public init(_dataDict: DataDict) { __data = _dataDict }
          ...
          public struct From: OpenTripPlannerApi.SelectionSet {
            ...
            public struct Stop: OpenTripPlannerApi.SelectionSet {
              ...
              ///
              /// Parent Type: `Stop`
              public struct ParentStation: OpenTripPlannerApi.SelectionSet {
                public let __data: DataDict
                public init(_dataDict: DataDict) { __data = _dataDict }
      ...
      public struct RoutingError: OpenTripPlannerApi.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: ApolloAPI.ParentType { OpenTripPlannerApi.Objects.RoutingError }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
          .field("code", GraphQLEnum<OpenTripPlannerApi.RoutingErrorCode>.self),
          .field("inputField", GraphQLEnum<OpenTripPlannerApi.InputField>?.self),
          .field("description", String.self),
        ] }

        /// An enum describing the reason
        public var code: GraphQLEnum<OpenTripPlannerApi.RoutingErrorCode> { __data["code"] }
        /// An enum describing the field which should be changed, in order for the search to succeed
        public var inputField: GraphQLEnum<OpenTripPlannerApi.InputField>? { __data["inputField"] }
      ...
      public struct DebugOutput: OpenTripPlannerApi.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: ApolloAPI.ParentType { OpenTripPlannerApi.Objects.DebugOutput }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
          .field("totalTime", OpenTripPlannerApi.Long?.self),
          .field("timedOut", Bool?.self),
        ] }

        public var totalTime: OpenTripPlannerApi.Long? { __data["totalTime"] }
